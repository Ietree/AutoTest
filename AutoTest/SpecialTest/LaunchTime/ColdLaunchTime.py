...
class App(object):
    ...
    def launch_app(self):
        ...
        # start_cmd = "adb shell am start -W -n dji.go.v5/com.dji.mainpageui.device.DJIDeviceActivity"
    ...
    def stop_app(self):
        ...
        杀掉App进程
        """
        stop_cmd = "adb shell am force-stop dji.go.v5"
        os.popen(stop_cmd)
...
class Controller(object):
    ...
    def save_data_to_csv(self):
        ...
        将数据存入CSV文件中
        """
        # csv_file = open("ColdLaunchTime.csv", "w")
        # writer = csv.writer(csv_file)
        # writer.writerows(self.all_data)
        # csv_file.close()
        with open("ColdLaunchTime.csv", "w", newline="") as csv_file:
            writer = csv.writer(csv_file)
            writer.writerows(self.all_data)
